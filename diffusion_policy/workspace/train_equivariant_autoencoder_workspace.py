...
from diffusion_policy.model.equi.equi_obs_autoencoder import EquivariantAutoencoder


OmegaConf.register_new_resolver("eval", eval, replace=True)

class TrainEquivariantAutoencoderWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model = EquivariantAutoencoder()
        self.model: EquivariantAutoencoder = hydra.utils.instantiate(cfg.autoencoder)

        self.ema_model: EquivariantAutoencoder = None
