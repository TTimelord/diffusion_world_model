...
class TrainEquivariantLatentDiffusionWorldModelUnetImageWorkspace(BaseWorkspace):
                    ...
                    with torch.inference_mode():
                        ...
                        for idx in selected_indices:
                            ...
                            for i in tqdm.trange(episode_length - world_model.n_obs_steps):
                                ...
                                predicted_results_rot = world_model.predict_future(predicted_image_history_rot, action_rot, last_latent=last_latent_rot) # B, T, C, H, W
